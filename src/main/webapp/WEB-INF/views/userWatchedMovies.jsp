...
<head>
    ...
    <!-- External CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/showAllmovietouser.css" />
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="movieSearch" onkeyup="searchMoviesU(this.value)" placeholder="Search for movies..">
        </div>
